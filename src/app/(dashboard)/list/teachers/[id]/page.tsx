      ...
      <div className="w-full xl:w-2/3">
        ...
        <div className="flex flex-col lg:flex-row gap-4">
          ...
          <div className="bg-lamaSky py-6 px-4 rounded-md flex-1 flex gap-4 items-center">
            <div className="w-1/3">
              <Image
                src="https://images.pexels.com/photos/2888150/pexels-photo-2888150.jpeg?auto=compress&cs=tinysrgb&w=120"
                alt=""
                width={144}
                height={144}
            ...
            <div className="w-2/3 flex flex-col justify-between gap-4">
              <div className="flex items-center gap-4">
                ...
                <FormModal
                  ...
                  data={{
                    id: 1,
                    username: "deanguerreru",
                    email: "deanguerreru@gmail.com",
                    password: "password",
                    firstName: "Dean",
                    lastName: "Guerrero",
                    phone: "+8903 32439",
                    address: "1234 street NewYork",
                    bloodType: "A+",
                    dateOfBirth: "2000-02-02",
                    gender: "male",
                    img: "https://images.pexels.com/photos/2888150/pexels-photo-2888150.jpeg?auto=compress&cs=tinysrgb&w=120",
                  }}
                />
              </div>
          ...
          {/* SMALL CARDs*/}
          <div className="flex-1 flex gap-2 md:grid-cols-2 2xl:grid-cols-2 justify-between flex-wrap text-xs font-medium w-full">
            {/* CARD */}
        ...
        <div className="bg-white p-4 rounded-md">
          ...
          <div className="mt-4 flex gap-4 flex-wrap text-xs text-gray-500">
            ...
            <Link
              ...
              className="p-3 rounded-md bg-emerald-50"
            >
